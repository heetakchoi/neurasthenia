...
function chat(user_name, msg){
	var old = parent.window.mainframe.document.all.msg_area_id.value;
	parent.window.mainframe.document.all.msg_area_id.value = old + "\n" + user_name + " : " + msg;
	parent.window.mainframe.document.all.msg_area_id.scrollTop = parent.window.mainframe.document.all.msg_area_id.scrollHeight; 
	return;
}
